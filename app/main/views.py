...
@main.route('/product-promo/pitches/')
def promo():
    '''
    View root page function that returns the index page and its data
    '''
    ...
    return render_template('product_promo.html', title = title, pitches= pitches )

@main.route('/social/pitches/')
def social():
    '''
    View root page function that returns the index page and its data
    '''
    ...
    return render_template('social.html', title = title, pitches= pitches )
...
def environment():
    ...
    pitches= Pitch.get_all_pitches()
    return render_template('environment.html', title = title, pitches= pitches )

@main.route('/academic/pitches/')
def academic():
    '''
    View root page function that returns the index page and its data
    '''
    title = 'Product Pitches'
    pitches= Pitch.get_all_pitches()
    return render_template('academic.html', title = title, pitches= pitches )
  
@main.route('/humor/pitches/')
def humor():
    '''
    View root page function that returns the index page and its data
    '''
    title = 'Product Pitches'
    pitches= Pitch.get_all_pitches()
    return render_template('humor.html', title = title, pitches= pitches )
